...
let pickaxes = objectMap(mainPickaxes, (pick) => {return pick.owns});
const pickaxeNames = objectMap(mainPickaxes, (pick) => {return pick.name});
const pickaxeDescriptions = objectMap(mainPickaxes, (pick) => {return pick.description});
const pickaxeSillyDescriptions = objectMap(mainPickaxes, (pick) => {return pick.sillyDescription});